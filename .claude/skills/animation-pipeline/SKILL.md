...
| 타입 | 목표 프레임 | 추출 fps | 동영상 duration | aspect_ratio | resolution |
|------|-----------|---------|----------------|-------------|-----------|
| idle | 4 | 2 | 2초 | 9:16 | 480p |
| walk | 6 | 2 | 3초 | 9:16 | 480p |
| attack | 6 | 2 | 3초 | 9:16 | 480p |
...
| 프레임 수 | 목표 수량 달성 (idle 12, walk 12, attack 16) | fps 조정 |
