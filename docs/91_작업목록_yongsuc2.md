...
| Y-84 | 일반 적 챕터 스케일링 강화 | 하 | 완료 | 일반 적 전용 normalScalingPerChapter(1.28) 추가, 엘리트/보스는 기존 scalingPerChapter(1.25) 유지, EnemyTable.GetNormalScaledStats 메서드, Chapter.CreateCombatBattle에서 적용 |
