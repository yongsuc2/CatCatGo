...
{
    public class SkillTierDataLoader
    {
        private Dictionary<string, Dictionary<int, Dictionary<string, float>>> _nested;
        private readonly string _jsonFileName;

        public SkillTierDataLoader(string jsonFileName)
        {
        ...
        private void EnsureLoaded()
        {
            ...
            var rows = JsonDataLoader.LoadJArray(_jsonFileName);
            if (rows == null) return;
        ...
        public Dictionary<string, Dictionary<int, Dictionary<string, float>>> GetAll()
        {
            EnsureLoaded();
            return _nested;
        }

        public Dictionary<string, float> GetTierData(string id, int tier)
        {
            EnsureLoaded();
        ...
        public Dictionary<int, Dictionary<string, float>> GetFamily(string id)
        {
            EnsureLoaded();
