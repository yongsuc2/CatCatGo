    ...
    public class TalentScreen : BaseScreen
    {
        ...
        private void RefreshRewardWindow(int totalLevel)
        {
            ...
            foreach (var node in nodesInWindow)
            {
                ...
                bool isApplied = node.Claimed || (node.Reached && node.IsTransition);
